...
class DateBehaviours extends FieldBehaviours {
  ...
  def dateFieldWithMax(form: Form[?], key: String, max: LocalDate, errorKey: String, errorArgs: Seq[String] = Seq.empty): Unit = {
  ...
  def dateFieldWithMin(form: Form[?], key: String, min: LocalDate, errorKey: String, errorArgs: Seq[String] = Seq.empty): Unit = {
