...
class CanPhoneIndividualControllerSpec extends SpecBase with MockitoSugar {
  ...
  "CanPhoneIndividual Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      val userAnswers = minimalUserAnswers.set(CanPhoneIndividualPage, true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val expectedAnswers = minimalUserAnswers.set(CanPhoneIndividualPage, true).success.value
