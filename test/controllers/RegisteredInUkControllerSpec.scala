...
class RegisteredInUkControllerSpec extends SpecBase with MockitoSugar {
  ...
  "RegisteredInUk Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = minimalUserAnswers.set(RegisteredInUkPage, true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val updatedAnswers = minimalUserAnswers.set(RegisteredInUkPage, true).success.value
